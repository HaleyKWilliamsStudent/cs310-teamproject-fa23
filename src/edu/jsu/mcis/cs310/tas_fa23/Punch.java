...
public class Punch {
    ...
    /**
     * Gets the adjusted timestamp for this punch event. This can be used for
     * corrections or adjustments to the original timestamp.
     *
     ...
     *
     * @return An EventType representing the punch type (CLOCK_IN, CLOCK_OUT,
     * TIME_OUT, etc.).
     */
     ...
     *
     * @return A string formatted as "#{badgeId} {punchType}: {Day MM/dd/yyyy}
     * {HH:mm:ss}".
     */
